...
<form class="stat-box" method="get">
    ...
    <select name="kieuthongke">
        <option <?= $kieuthongke=='Thống kê theo đơn'?'selected':'' ?>>
            Thống kê theo đơn
        </option>
        <option <?= $kieuthongke=='Thống kê doanh thu'?'selected':'' ?>>
            Thống kê doanh thu
        </option>
    </select>
...
<div class="summary">
    ...
    Tổng doanh thu: <b><?= number_format($tongtien) ?>đ</b>
</div>
